    ...
    <section id="top" ref={ref} className="relative h-[100svh] min-h-[640px] w-full overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h1 className="font-serif text-[clamp(6rem,20vw,16rem)] font-semibold leading-[0.9] tracking-tighter text-primary-foreground drop-shadow-2xl whitespace-nowrap">
            <motion.span
